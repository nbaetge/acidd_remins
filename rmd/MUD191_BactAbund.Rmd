...
This document shows how **individual bottle**  bacterial abundance data from Mud experiments were processed, QC'd, and analyzed. 
...
This plot makes it little easier to see, with the data that we have, that exponential growth occurs for each bottle: ~0.5-2.5 d (T0.5-T2.5)
