...
sd_ba_curves <- readRDS("~/GITHUB/acidd_remins/output/sd_ba_curves.rds")
...
(sb_ba_curves + (sb_toc_curves + guides(fill = F))) /  (sd_ba_curves + guides(fill = F)) + plot_layout(guides = "collect") & plot_annotation(, tag_levels = "A")
```
